 ...
 * @WNCK_WINDOW_STATE_MAXIMIZED_LEFT: the window is filling left half of work area.
 * @WNCK_WINDOW_STATE_MAXIMIZED_RIGHT: the window is filling right half of work area.
 *
...
typedef enum
{
  ...
  WNCK_WINDOW_STATE_MAXIMIZED_LEFT         = 1 << 19,
  WNCK_WINDOW_STATE_MAXIMIZED_RIGHT        = 1 << 20
} WnckWindowState;
 ...
 * @WNCK_WINDOW_ACTION_MAXIMIZE_LEFT: the window may be made to fill left half of available area.
 * @WNCK_WINDOW_ACTION_UNMAXIMIZE_LEFT: the window may be restored from left half of available area.
 * @WNCK_WINDOW_ACTION_MAXIMIZE_RIGHT: the window may be made to fill right half of available area.
 * @WNCK_WINDOW_ACTION_UNMAXIMIZE_RIGHT: the window may be restorted from right half of available area.
 *
...
typedef enum
{
  ...
  WNCK_WINDOW_ACTION_MAXIMIZE_LEFT           = 1 << 24,
  WNCK_WINDOW_ACTION_UNMAXIMIZE_LEFT         = 1 << 25,
  WNCK_WINDOW_ACTION_MAXIMIZE_RIGHT          = 1 << 26,
  WNCK_WINDOW_ACTION_UNMAXIMIZE_RIGHT        = 1 << 27
} WnckWindowActions;
...
gboolean wnck_window_is_maximized_left         (WnckWindow *window);
gboolean wnck_window_is_maximized_right        (WnckWindow *window);
...
void wnck_window_float                   (WnckWindow *window);
...
void wnck_window_maximize_left           (WnckWindow *window);
void wnck_window_unmaximize_left         (WnckWindow *window);
void wnck_window_maximize_right          (WnckWindow *window);
void wnck_window_unmaximize_right        (WnckWindow *window);
